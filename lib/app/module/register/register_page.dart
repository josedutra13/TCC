          ...
          Container(
            ...
            child: Padding(
              ...
              child: Form(
                  child: Column(
                children: [
                  RegisterInput(label: 'USUÁRIO',
                                placeholder: 'Informe seu usuário',
                                onChanged: (value) => {},),
                  RegisterInput(label: 'E-MAIL', placeholder: 'Informe seu e-mail',onChanged: (value) => {}),
                  Obx(() =>PasswordInput(label: 'SENHA',
                                placeholder: 'Informe sua senha',
                                controller: controller.passwordController,
                                autovalidateMode: AutovalidateMode.onUserInteraction,
                                onChanged: (value) => {},
                                obscureText: !controller.showPassword,
                                onShowPassword: (){controller.showPassword = !controller.showPassword;})),
                  PasswordInput(label: 'CONFIRMAR SENHA',
                                placeholder: 'Confirme sua senha',
                                obscureText: !controller.showPassword,
                                obscureTextOption: false,),
                  RegisterInput(label: 'TELEFONE', placeholder: 'Informe seu telefone',onChanged: (value) => {}),
                  RegisterInput(label: 'ENDEREÇO', placeholder: 'Informe seu endereço',onChanged: (value) => {}),
