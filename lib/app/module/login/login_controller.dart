...
class LoginController extends GetxController {
  ...
  Future<void> login(BuildContext context) async {
    ...
    if (formLogin.currentState!.validate()) {
      if (response!.id != null) {
        dependencies.userDTO.nome = response.nome;
        dependencies.userDTO.id = response.id;
        dependencies.userDTO.isPerson = response.isPerson;
        print('logou foi esse aqui ${dependencies.userDTO}');
